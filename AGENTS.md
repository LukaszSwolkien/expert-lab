...
3. **Determine additional skills.** Check `skills/README.md` for skills that match the task intent or file type. Multiple skills may be combined.
4. **Execute** using persona style + skill workflow(s).
